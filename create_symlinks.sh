# Create messy symlinks that aren't often created
...
ln -s /usr/lib/systemd/user/umtprd-manager.service overlay/system/etc/systemd/user/graphical-session.target.wants/umtprd-manager.service
...
# Fix vndservicemanager permissions

chmod 755 overlay/system/usr/share/halium-overlay/vendor/bin/vndservicemanager

# Fix USB scripts permissions

chmod 755 overlay/system/usr/bin/*
